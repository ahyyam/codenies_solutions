      ...
      <section className="bg-gradient-innovation relative overflow-hidden section-py-lg">
        ...
        <div className="container-mobile text-center relative z-10">
          ...
          <div className="flex items-center justify-center gap-4 text-sm text-white/90 mb-6">
            <div className="flex items-center gap-2"><span className="inline-block w-2 h-2 rounded-full bg-white/80" /> Conversion optimized</div>
            <div className="flex items-center gap-2"><span className="inline-block w-2 h-2 rounded-full bg-white/80" /> Secure payments</div>
            <div className="flex items-center gap-2"><span className="inline-block w-2 h-2 rounded-full bg-white/80" /> Mobile first</div>
          </div>
          <Link 
            href="/consultation" 
