...
const PrivacyPolicyPage = () => {
  return (
    <div className="min-h-screen bg-background">
      {/* Hero Section */}
      <section className="section-padding bg-background border-b border-border" aria-labelledby="privacy-hero-heading">
        <div className="container-mobile text-center max-w-4xl">
          <div className="flex justify-center mb-6">
            <Shield className="h-16 w-16 text-primary" />
          </div>
          <h1 id="privacy-hero-heading" className="text-4xl sm:text-5xl md:text-6xl font-bold text-foreground mb-6 leading-tight">
            Privacy Policy
          </h1>
      ...
      {/* Privacy Content */}
      <section className="section-padding" aria-labelledby="privacy-content">
